...
import {
  Calendar, Phone, ChevronRight, Check,
  FileText, Clock, User, Mail, Users, MapPin,
} from "lucide-react";
...
export function EmbedReservationWidget({ venue, widget }: Props) {
  ...
  async function handleSubmit() {
    setSubmitting(true);
    try {
      const host = widget.apiEndpoint || window.location.origin;
      const endpoint = `${host}/api/reservations`;
      ...
      setSubmitted(true);
      window.parent.postMessage("bw:submitted", "*");
    } catch {
  ...
  function handleClose() {
    window.parent.postMessage("bw:close", "*");
  }
        ...
        {submitted ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-500 mb-6">
              {widget.businessName} will confirm your booking shortly.
            </p>
